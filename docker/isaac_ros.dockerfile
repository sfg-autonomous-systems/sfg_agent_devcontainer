...
FROM --platform=arm64 isaac-ros-base AS base-arm64
...
FROM --platform=amd64 isaac-ros-base AS base-amd64
FROM base-${PLATFORM} AS isaac-ros
...
#########################################################################################################
# Setup Isaac ROS apt legacy repository.                                                                #
#########################################################################################################
